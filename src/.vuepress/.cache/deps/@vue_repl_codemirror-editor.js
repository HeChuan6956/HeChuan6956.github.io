...
// ../../node_modules/.pnpm/@vue+repl@4.3.1/node_modules/@vue/repl/dist/codemirror-editor.js
import "C:/Users/22068/Desktop/Projject/vuepress-theme-hope/node_modules/.pnpm/@vue+repl@4.3.1/node_modules/@vue/repl/dist/codemirror-editor.css";
    ...
    (function(mod) {
      ...
      CodeMirror2.defineExtension("openDialog", function(template, callback, options) {
        ...
        if (inp) {
          ...
          if (options.closeOnBlur !== false) CodeMirror2.on(dialog2, "focusout", function(evt) {
          ...
          if (options.closeOnBlur !== false) CodeMirror2.on(button, "blur", close);
          button.focus();
        }
        return close;
      });
...
(function(module, exports) {
  (function(mod) {
    ...
    function insertLine(cm, above) {
      if (cm.isReadOnly()) return CodeMirror2.Pass;
      cm.operation(function() {
    ...
    function wordAt(cm, pos) {
      ...
      while (start && CodeMirror2.isWordChar(line.charAt(start - 1))) --start;
      while (end < line.length && CodeMirror2.isWordChar(line.charAt(end))) ++end;
    ...
    function isSelectedRange(ranges, from, to) {
      for (var i = 0; i < ranges.length; i++)
        if (CodeMirror2.cmpPos(ranges[i].from(), from) == 0 && CodeMirror2.cmpPos(ranges[i].to(), to) == 0) return true;
      return false;
    }
    var mirror = "(){}[]";
    ...
    cmds.selectBetweenBrackets = function(cm) {
      if (!selectBetweenBrackets(cm)) return CodeMirror2.Pass;
    };
    ...
    cmds.goToBracket = function(cm) {
      cm.extendSelectionsBy(function(range) {
        ...
        if (next && CodeMirror2.cmpPos(next.pos, range.head) != 0) return next.pos;
    ...
    function modifyWordOrSelection(cm, mod) {
      cm.operation(function() {
        ...
        for (var i = indices.length - 1, at; i >= 0; i--) {
          ...
          if (at && CodeMirror2.cmpPos(range.head, at) > 0) continue;
    ...
    cmds.smartBackspace = function(cm) {
      if (cm.somethingSelected()) return CodeMirror2.Pass;
      cm.operation(function() {
