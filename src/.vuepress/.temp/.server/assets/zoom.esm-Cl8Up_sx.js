...
var t = () => e, o = function() {
  ...
  function s(t3, o2) {
    var n2 = r();
    if (t3.width = t3.width || 1, t3.height = t3.height || 1, t3.x -= (window.innerWidth - t3.width * o2) / 2, t3.y -= (window.innerHeight - t3.height * o2) / 2, l) if (1 === o2) document.body.style.transform = "";
    else {
    ...
    else 1 === o2 ? (document.body.style.position = "", document.body.style.left = "", document.body.style.top = "", document.body.style.width = "", document.body.style.height = "", document.body.style.zoom = "") : (document.body.style.position = "relative", document.body.style.left = -(n2.x + t3.x) / o2 + "px", document.body.style.top = -(n2.y + t3.y) / o2 + "px", document.body.style.width = 100 * o2 + "%", document.body.style.height = 100 * o2 + "%", document.body.style.zoom = o2);
